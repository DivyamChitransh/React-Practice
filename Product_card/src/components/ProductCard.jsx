  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <button onClick={() => addTocart(product)} className="flex-1 rounded-lg bg-blue-600 px-3 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700">Add to Cart</button>
